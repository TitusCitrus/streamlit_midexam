...
def main():
    ...
    market_segment = st.selectbox("Market Segment", min_value=1, max_value=5, value=2)
    repeated_guest = st.selectbox("Is Repeated Guest", min_value=0, max_value=1, value=0)
